...
-- Disable RLS on investicore tables for unrestricted API access (or grant full permissions)
ALTER TABLE investicore.sec_filings DISABLE ROW LEVEL SECURITY;
ALTER TABLE investicore.filing_documents DISABLE ROW LEVEL SECURITY;
ALTER TABLE investicore.financial_periods DISABLE ROW LEVEL SECURITY;
ALTER TABLE investicore.financial_metrics DISABLE ROW LEVEL SECURITY;
ALTER TABLE investicore.ncav_analysis DISABLE ROW LEVEL SECURITY;
ALTER TABLE investicore.catalysts DISABLE ROW LEVEL SECURITY;
ALTER TABLE investicore.valuation_snapshots DISABLE ROW LEVEL SECURITY;
ALTER TABLE investicore.research_alerts DISABLE ROW LEVEL SECURITY;
